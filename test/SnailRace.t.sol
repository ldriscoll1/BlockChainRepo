...
contract ContractTest is Test {
    ...
    function testCompleteGame() public {
        ...
        snailrace.assignPlayers(address(1), address(2), 1);
    ...
    function testLeaderboard() public {
        ...
        snailrace.assignPlayers(address(1), address(2), 1);
        snailrace.assignPlayers(address(3), address(4), 2);
        snailrace.assignPlayers(address(5), address(6), 3);
        ...
        assertLe(snailrace.getLeaderboardEntryRaceTime(0), snailrace.getLeaderboardEntryRaceTime(1));
        // //Make sure the leaderboard is sorted
